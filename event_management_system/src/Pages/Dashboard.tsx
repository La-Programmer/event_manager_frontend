                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className=" col-span-3">
                    <div className="grid grid-cols-3">
                      <div className="  flex justify-center items-center size-[120px] bg-[#007AFF33] hover:bg-[#007bff4c] text-[#007AFF] rounded-[15px] ">
...
<img src={dashFram} alt=""  className="h-6 my-4 w-full"/>
                    ...
                    <div className="grid grid-cols-3">
                      <div className="  flex justify-center items-center size-[120px] bg-[#FF3D0033] hover:bg-[#ff3c0045] text-[#FF3D00] rounded-[15px] ">
                        <div className="flex flex-col items-center space-y-4">
                          <div className="">
                            <svg
                              width="10"
